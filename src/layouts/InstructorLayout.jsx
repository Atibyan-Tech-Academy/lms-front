...
import aoi_portal from "../assets/aoi-portal.png"
...
export default function InstructorLayout() {
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src={aoi_portal} class="h-8" alt="Flowbite Logo" />
  ...
  <div class="flex md:order-2">
    ...
    <img class="w-8 h-8 rounded-full ms-5" src="/docs/images/people/profile-picture-3.jpg" alt="user photo"></img>
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
      ...
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700" style={{gap:'50%'}}>
        <li>
