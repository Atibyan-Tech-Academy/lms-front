...
const EditProfile = () => {
  ...
  return (
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white shadow rounded mt-5" >
  ...
  {preview && (
    <img
      src={preview}
      alt="Preview"
      className="w-20 h-20 rounded-full mb-2 object-cover mb-5"
    />
  )}
  ...
  <input type="file" name="profile_image" onChange={handleChange} />
        ...
        <div className="relative">
          <input
            ...
            onChange={handleChange}
            className="w-full border p-2 rounded pr-10 mb-5"
          />
          <button
            type="button"
            onClick={() => setShowPassword(!showPassword)}
            className="absolute right-2 top-2 text-gray-600 mb-5"
          >
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white bg-green-800  px-4 py-2 rounded mb-5"
        >
          Save Changes
        </button>
      </form>
